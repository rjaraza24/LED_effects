...
//        leds2[i].r = leds2[i].r + Color.r;
//          
//      if (leds2[i].g + Color.g > 255)
//        leds2[i].g = 255;
//      else if (leds2[i].g + Color.g < 0)
//        leds2[i].g = 0;
//      else 
//        leds2[i].g = leds2[i].g + Color.g;
//
//      if (leds2[i].b + Color.b > 255)
//        leds2[i].b = 255;
//      else if (leds2[i].b + Color.b < 0)
//        leds2[i].b = 0;
//      else 
//        leds2[i].b = leds[i].b + Color.b;  
//      
    //All the other LEDs begin their fading journey to eventual total darkness
     else {
      leds[i] = CRGB(leds[i].r/fade_scale, leds[i].g/fade_scale, leds[i].b/fade_scale);
      leds2[i] = CRGB(leds2[i].r/fade_scale, leds2[i].g/fade_scale, leds2[i].b/fade_scale);
    }
  FastLED.show(); 
}
