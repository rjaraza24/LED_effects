...
int ls = 20;
#include "FastLED.h"
#define NUM_LEDS 60 //milkLED
#define NUM_LEDS2 60 //barLED
...
//  delay(500);
   colorWipe(0x65,0x00,0xcc,ls );//violet

  colorWipe(0x00,0x00,0x00, ls);
   
//  colorWipe2(0x00,0x00,0x00, ls);

     colorWipe2(0x65,0x00,0xcc,ls );//violet
   
  colorWipe2(0x00,0x00,0x00, ls);

//  colorWipe2(0xdd,0x00,0xdd, ls );//pink
